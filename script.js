...
function guessing() {
  ...
  if (input_value == correct_name) {
    ...
    document.getElementById("img"+(guesses).toString()).parentElement.style.outline = "3px solid #22262d";
    document.getElementById("img"+(guesses+1).toString()).parentElement.style.outline = "3px solid #f44336";
...
function fading_border(guesses) {
  ...
  for (var i = 0; i < length; i++) {
    let hex = "#" + colorToHex(newy[0]) + colorToHex(newy[1]) + colorToHex(newy[2]);
...
function win() {
  ...
  document.getElementById("guesses-p").innerHTML = "Guesses: " + guesses.toString() + "/6";
  document.getElementById("name-p").innerHTML = correct_name;
  document.getElementById("img"+(guesses).toString()).parentElement.style.outline = "3px solid #00ba4d";
...
function lost() {
  ...
  document.getElementById("guesses-p").innerHTML = "Guesses: " + guesses.toString() + "/6";
  document.getElementById("name-p").innerHTML = correct_name;
  document.getElementById("img"+(guesses).toString()).parentElement.style.outline = "3px solid #f44336";
